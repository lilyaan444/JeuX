...
void ajouterPionJ1(struct Plateau *pl, int L, int C, int jeton1){
    ...
    // vérifier que la case n'est pas utiliser (fait) vérifier que la case est dans le tableau (a faire)
...
while (true)
{
    while (true)
    {
        if ((ligne >= 0 && ligne < L) && (colonne >= 0 && colonne < C)){
            break;
        }else{
...
//------------------------------------VerifierVainqueur----------------------------------------//
int somme (struct Plateau *pl, int L, int C, int nb_partie, int scorePartieJ1, int scorePartieJ2){
...
//------------------------------------JouerPartie----------------------------------------//
void jouerPartie(struct Plateau *pl, int L, int C, bool continuer, char q, char joueur1, char joueur2, int nb_partie, int scorePartieJ1, int scorePartieJ2){
